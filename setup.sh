...
# Usage start
#Types: deb
#URIs: https://mirror.intra/download.docker.com/linux/ubuntu
#Suites: noble
#Components: stable
...
# ---start---Kubernetes Ubuntu Noble---
# Kubernetes for Ubuntu 24.04 (Noble Numbat) - AMD64 architecture
deb https://pkgs.k8s.io/core:/stable:/v1.33/deb/ noble main
# Usage start
#Types: deb
#URIs: https://mirror.intra/pkgs.k8s.io/core:/stable:/v1.31/deb
#Suites: noble
#Components: main
#Signed-By: /usr/share/keyrings/kubernetes-archive-keyring.gpg
# Usage end
# ---end---Kubernetes Ubuntu Noble---

# ---start---Kubernetes Debian 13---
# Kubernetes for Debian 13 (Trixie) - AMD64 architecture
deb https://pkgs.k8s.io/core:/stable:/v1.33/deb/ trixie main
# Usage start
#Types: deb
#URIs: https://mirror.intra/pkgs.k8s.io/core:/stable:/v1.31/deb
#Suites: trixie
